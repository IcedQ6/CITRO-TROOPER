...
public class BossMech2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bossMain = GameObject.FindObjectOfType<BossMain2>();
        bossHealth = GameObject.FindObjectOfType<Boss2Health>();
    }
    ...
    private IEnumerator MoveAndShootRoutine()
{
    while (true)
    {
        yield return new WaitUntil(() => BossMain.GetComponent<BossMain2>().arrived);
